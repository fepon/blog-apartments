...
import { ObjFragmentProps, PostType } from 'types'

const PostDetail: React.FC<{ post: PostType }> = ({ post }) => {
  const getContentFragment = (
    index: number,
    text: any,
    obj: ObjFragmentProps,
    type?: string
  ) => {
  ...
  return (
    <div className="mb-8 rounded-lg bg-white pb-12 shadow-lg lg:p-8">
      ...
      <div className="px-4 lg:px-0">
        ...
        {post.content.raw.children.map((typeObject: any, index: number) => {
          const children = typeObject.children.map(
